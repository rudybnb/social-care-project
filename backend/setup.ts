...
const setup = async () => {
  ...
  try {
    ...
    if (existingAdmin.length === 0) {
      ...
      console.log('✅ Admin staff account created (username: admin, password: admin123)');
    }
    ...
    if (existingManager.length === 0) {
      ...
      console.log('✅ Manager staff account created (username: manager, password: manager123)');
    }
